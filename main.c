...
int main(void)
{
    ...
    Body_setShapeBox(&box1, 25, 25);

    box2 = Body_new(250, 250, 50.0f);
    Body_setShapeBox(&box2, 25, 25);
    ...
    while (!WindowShouldClose()) // Detect window close button or ESC key
    {
        ...
        */
        ...
        BeginDrawing();
        {
            ...
            {
                Graphics_drawPolygon(box1.position, box1.shape->polygon.worldVertices, box1.rotation, RED);
                Graphics_drawPolygon(box2.position, box2.shape->polygon.worldVertices, box2.rotation, RED);
            }
            else
            {
